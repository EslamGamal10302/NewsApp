...
public struct ToastStyle {
    ...
    */
    public var backgroundColor: UIColor = UIColor(named: K.REFRESH_COLOUR)!.withAlphaComponent(1)
    
    /**
     The title color. Default is `UIColor.whiteColor()`.
    */
    public var titleColor: UIColor = UIColor(named: K.WARNING_TEXT_COLOUR) ?? .white
    
    /**
     The message color. Default is `.white`.
    */
    public var messageColor = UIColor(named: K.WARNING_TEXT_COLOUR)
